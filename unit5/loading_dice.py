...
# Note rolls must be an iterator b/c play_pig uses the next()
# function to retrieve the next value returned by dierolls
# parameter. We can also use a generator function
# for the dierolls param
