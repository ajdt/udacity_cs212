...
def solve(formula):
    ...
    # Your code here
    for solution in fill_in(formula):
        if valid(solution):
            return solution
    return None
...
# NORVIG'S SOLUTION IS THE SAME, EXCEPT HE DOESN'T EXPLICITLY RETURN NONE
# IT HAPPENS IMPLICITLY WHEN WE REACH THE END OF THE FUNCTION.
