...
# testing solutions of edge cases, --- Armando Diaz T. 
>>> elapsed_time(bridge_problem([0, 0, 0, 0]))
0

>>> len(path_actions(bridge_problem([0, 0, 0, 0])))
5

>>> [ 'light' in t and not 'light' in h for h, t, time in path_states( bridge_problem([1, 2, 5, 10]) )[1::2] ]
[ True, True, True ]
"""
