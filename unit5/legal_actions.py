...
def play_pig(A, B, dierolls=dierolls()):
    ...
    while True:
        ...
        if me >= goal:
            ...
            state = (p, 0, goal, 0) # other person wins automatically

        # Norvig's code made more sense
        # his else statement just returned:
        #       strategies[other[p]]
        # this makes more sense, then messing with the
        # state and letting the loop return indirectly
